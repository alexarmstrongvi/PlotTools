...
plot_defaults = {
    ...
    'DphiLep0MET'          : Plot1D( bin_range=[-0.2, 3.3], bin_width=0.1, add_underflow=True, xlabel='#Delta#phi(l_{0},MET)', xcut_is_max=False),
    'DphiLep1MET'          : Plot1D( bin_range=[-0.2, 3.3], bin_width=0.1, add_underflow=True, xlabel='#Delta#phi(l_{1},MET)', xcut_is_max=False),
    ...
    'l_mT[1]'              : Plot1D( bin_range=[0.0, 200.0],  bin_width=5, xunits='GeV', xlabel='m_{T}^{lep1}'),
    'l_mT[0]'              : Plot1D( bin_range=[0.0, 200.0],  bin_width=5, xunits='GeV', xlabel='m_{T}^{lep0}'),
    ...
    'dpt_ll:drll'         : Plot2D( bin_range = [1.5, 4, 0, 50], xbin_width=0.1, ybin_width=1, xlabel="#DeltaR(lep0,lep1)", ylabel='#Deltap_{T}^{ll}'),
